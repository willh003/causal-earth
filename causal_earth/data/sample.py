...
class PooledRGBDataset(Dataset):
    ...
    def __init__(self, directory):
        ...
        print(f"Found {len(self.image_locations)} RGB images across {len(self.file_paths)} files")
    ...
    def __getitem__(self, idx):
        ...
        with xr.open_dataset(file_path) as dataset:
            rgb_images = extract_all_rgb(dataset) # NOTE: A bit wasteful since we load ~27 images and only keep 1.
